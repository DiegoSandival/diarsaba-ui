...
const MONACO_BASE_URL = "https://unpkg.com/monaco-editor@0.49.0/min";
...
class CodeEditor {
                ...
                <div class="editor-title">
                    <div class="language-selector">
                        <button class="language-button" type="button" title="Seleccionar lenguaje">
                            <i class="${initialLanguage.icon}" style="color: ${initialLanguage.color};"></i>
    ...
    updateLanguageButton(elements, language) {
        ...
        elements.languageIcon.style.color = language.color;
    ...
    async open(title = "Editor de Código", code = "", language = "javascript") {
        ...
        return new Promise((resolve) => {
            ...
            registerListener(elements.closeButton, "click", () => closeEditor(""));
